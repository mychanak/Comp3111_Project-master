...
namespace SinExWebApp20273938.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult DisplayInfo()
        {
            ...
            if (Account == null)
                return HttpNotFound("Account not found with this username:" + UserName);

            if (Account is PersonalShippingAccount)
                return View("../PersonalShippingAccounts/DisplayInfo", (PersonalShippingAccount)Account);
            else
                return View("../BusinessShippingAccounts/DisplayInfo", (BusinessShippingAccount)Account);
        }
        ...
        public ActionResult Edit()
        {
            ...
            if (Account is PersonalShippingAccount)
                return View("../PersonalShippingAccounts/Edit", (PersonalShippingAccount)Account);
            else
