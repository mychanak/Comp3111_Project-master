        ...
        protected override void Seed(SinExWebApp20273938.Models.SinExDatabaseContext context)
        {
            ...
            */
            ...
            context.PackageTypeSizes.AddOrUpdate(
                ...
                new PackageTypeSize { PackageTypeSizeID = 1, SizeAndWeight = "(Size: 250x350mm; Weight Limit: Not Applicable)", WeightLimit = null, PackageTypeID = 1 },
                new PackageTypeSize { PackageTypeSizeID = 2, SizeAndWeight = "(Size: small - 350x400mm; Weight Limit: 5kg)", WeightLimit = 5, PackageTypeID = 2 },
                new PackageTypeSize { PackageTypeSizeID = 3, SizeAndWeight = "(Size: large - 450x550mm; Weight Limit: 5kg)", WeightLimit = 5, PackageTypeID = 2 },
                new PackageTypeSize { PackageTypeSizeID = 4, SizeAndWeight = "(Size: 1000x80mm; Weight Limit: Not Applicable)", WeightLimit = null, PackageTypeID = 3 },

                new PackageTypeSize { PackageTypeSizeID = 5, SizeAndWeight = "(Size: small - 300x250x150mm; Weight Limit: 10kg)", WeightLimit = 10, PackageTypeID = 4 },
                new PackageTypeSize { PackageTypeSizeID = 6, SizeAndWeight = "(Size: medium - 400x350x250mm; Weight Limit: 20kg)", WeightLimit = 20, PackageTypeID = 4 },
                new PackageTypeSize { PackageTypeSizeID = 7, SizeAndWeight = "(Size: large - 500x450x350mm; Weight Limit: 30kg)", WeightLimit = 30, PackageTypeID = 4 }
                );
